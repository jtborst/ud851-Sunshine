...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mWeatherTextView, mWeatherError;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWeatherError = (TextView) findViewById(R.id.tv_error_message);

        // TODO (17) Find the ProgressBar using findViewById
        pbWeatherLoading = (ProgressBar) findViewById(R.id.pd_loading_indicator);
    ...
    private void showWeatherDataView() {
        ...
        mWeatherError.setVisibility(View.INVISIBLE);
    }

    private void showWeatherErrorView() {
        mWeatherTextView.setVisibility(View.INVISIBLE);
        mWeatherError.setVisibility(View.VISIBLE);
    }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            pbWeatherLoading.setVisibility(View.INVISIBLE);
