...
//      TODO (7) Replace the single TextView with Views to display all of the weather info
        ...
        forecastAdapterViewHolder.weatherDescription.setContentDescription(descriptionA11y);
        ...
        String highA11y = mContext.getString(R.string.a11y_high_temp, highString);
         ...
         /* Set the text and content description (for accessibility purposes) */
        forecastAdapterViewHolder.weatherHighTemperture.setText(highString);
        forecastAdapterViewHolder.weatherHighTemperture.setContentDescription(highA11y);
        ...
        String lowA11y = mContext.getString(R.string.a11y_low_temp, lowString);
         ...
         /* Set the text and content description (for accessibility purposes) */
        forecastAdapterViewHolder.weatherLowTemperture.setText(lowString);
        forecastAdapterViewHolder.weatherLowTemperture.setContentDescription(lowA11y);
...
//      TODO (4) Replace the weatherSummary TextView with individual weather detail TextViews
        ...
        final TextView weatherHighTemperture;
        final TextView weatherLowTemperture;
...
//          TODO (6) Get references to all new views and delete this line
            ...
            weatherDate = (TextView) view.findViewById(R.id.date);
            weatherDescription = (TextView) view.findViewById(R.id.weather_description);
            weatherHighTemperture = (TextView) view.findViewById(R.id.high_temperature);
            weatherLowTemperture = (TextView) view.findViewById(R.id.low_temperature);
