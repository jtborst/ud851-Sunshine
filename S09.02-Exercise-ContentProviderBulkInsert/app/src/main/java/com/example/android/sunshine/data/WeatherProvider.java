        ...
        switch (sUriMatcher.match(uri)) {
            case CODE_WEATHER:
                ...
                try {
                    ...
                    for (ContentValues weather_entry :  values) {
                        long weatherDate = weather_entry.getAsLong(WeatherContract.WeatherEntry.COLUMN_DATE);
                        if (!SunshineDateUtils.isDateNormalized(weatherDate)) {
                            throw new IllegalArgumentException("wrong date");
                        }

                        long _id = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, weather_entry);
